...
describe("FirstCoin", function () {
  it("Should return the total coins = owners coins", async function () {
    ...
    const firstCoin: FirstCoin = await FirstCoin.deploy(1000);
...
describe("Token contract", function () {
  ...
  let Token: FirstCoin__factory;
  let hardhatToken: FirstCoin;
  ...
  beforeEach(async function () {
    ...
    Token = await ethers.getContractFactory("FirstCoin");
